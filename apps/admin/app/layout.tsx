...
import { AdminSignOutButton } from "../components/sign-out-button";
import "./globals.css";
...
export default function AdminLayout({ children }: { children: React.ReactNode }) {
  ...
  const isAuthenticated = session?.role === "OWNER";

  console.log(`[Admin Layout Audit] Checking session state:`, {
    tokenPresent: !!token,
            ...
            <div className="flex items-center gap-3">
              {isAuthenticated ? (
                ...
                <>
                  ...
                  <span className="text-xs font-mono text-slate-500">Not Authenticated</span>
                </>
              )}
            </div>
          </header>
