  ...
  return (
    <main className="min-h-screen bg-black text-white flex flex-col justify-between p-6 md:p-12">
      ...
      <div className="w-full max-w-6xl mx-auto flex items-center justify-between">
        <a href="/client-login" className="flex items-center gap-2 font-mono text-sm text-slate-400 hover:text-emerald-400 transition-colors">
          <span>←</span>
        ...
        <Card variant="bordered" className="p-8 bg-surface-100/80 border-slate-800 space-y-6">
          {isSubmitted ? (
            <div className="text-center space-y-4 animate-fade-in">
              <div className="w-12 h-12 rounded-full bg-emerald-950 border border-emerald-500 flex items-center justify-center mx-auto text-emerald-400 text-lg font-bold">
                ✓
              </div>
              <h4 className="text-base font-bold text-white">Instructions Sent</h4>
              <p className="text-xs text-slate-300 leading-relaxed">
                If an account exists for <span className="text-emerald-400 underline">{email}</span>, password reset instructions have been sent to your inbox.
              </p>
              <div className="pt-2">
                <a href="/client-login">
